...
namespace PIZZA.WebApi.Authentication
{
        ...
        //, IUserSecurityStampStore<ApplicationUser>
    {
        ...
        public UserStore(IApplicationUserRepository applicationUserRepository)
        {
        ...
        public async Task<ApplicationUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken)
        {
            ...
            return await userRepository.FindByName(normalizedUserName);
        }
        ...
        public async Task RemoveFromRoleAsync(ApplicationUser user, string roleName, CancellationToken cancellationToken)
        {
            ...
            await userRepository.RemoveFromRole(user, roleName);
        }
        ...
        public async Task<IList<string>> GetRolesAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            return await userRepository.GetRoles(user);
        }
        ...
        public async Task<bool> IsInRoleAsync(ApplicationUser user, string roleName, CancellationToken cancellationToken)
        {
            ...
            return await userRepository.IsInRole(user, roleName);
        }
        ...
        public async Task<IList<ApplicationUser>> GetUsersInRoleAsync(string roleName, CancellationToken cancellationToken)
        {
            ...
            return await userRepository.GetUsersInRole(roleName);
        }
